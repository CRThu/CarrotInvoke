 ...
 *
 * Behavioral contract: every combination of command format, argument type,
 * argument count, whitespace, line endings, and separators is tested here.
 * Future refactoring must keep all these tests green.
 */
#include "unity.h"
